...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-05-2019 a las 16:26:28
...
INSERT INTO `personajes` (`id`, `nombre`, `tipo`, `descripcion`) VALUES
(1, 'Eevee', 'Evolucion', 'Eevee es un Pokémon de tipo normal que se asemeja en tamaño y forma a un pequeño zorro. Posee largas orejas puntiagudas y una cola en forma de pincel. Su cuerpo, de constitución física ágil y flexible, está adaptado a la velocidad y la agilidad.'),
